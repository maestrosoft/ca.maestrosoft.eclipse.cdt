package ca.maestrosoft.eclipse.cdt.plugin.studio.toolchain.c2008.x86_amd64;

import org.eclipse.cdt.managedbuilder.core.IManagedIsToolChainSupported;
import org.eclipse.cdt.managedbuilder.core.IToolChain;
import org.osgi.framework.Version;

import ca.maestrosoft.eclipse.cdt.plugin.studio.toolchain.c2008.ToolchainScannerVersion;
...
public class ToolchainScannerSet extends ToolchainScannerVersion implements IManagedIsToolChainSupported {
	...
	public ToolchainSet getToolchainSet() {
		try {
			return ToolchainSet.valueOf("Microsoft_x86_64");
		}
